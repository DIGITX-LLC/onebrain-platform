...
//             <h2 className="text-2xl font-bold mt-8 mb-4">Why Choose OneBrain for ChatGPT in Bangladesh?</h2>
...
//             <h2 className="text-2xl font-bold mt-8 mb-4">What You Can Do with ChatGPT on OneBrain</h2>
...
//             <h2 className="text-2xl font-bold mt-8 mb-4">Creative ChatGPT Prompts You Should Try</h2>
...
//             <h2 className="text-2xl font-bold mt-8 mb-4">How to Buy ChatGPT in Bangladesh (Step-by-Step)</h2>
...
//             <h2 className="text-2xl font-bold mt-8 mb-4">Experience Smarter AI Today</h2>
//             <p className="text-gray-300">
...
import BlogDetailsFour from "../component/about/BlogDetailsFour";


export default function details4() {
  return <BlogDetailsFour />;
} 