                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="font-light text-lg lg:text-xl text-gray-400 leading-relaxed max-w-lg">
                            Access the industry's most powerful video models including <span className="text-gray-200">Sora, Veo, RunwayML, Kling, Hailuo, Wan,</span> and <span className="text-gray-200">Lightricks</span>.
                        </p>
